...
```r
ggplot(data = evals, aes(x = age)) +
  geom_density(nwidth = 2)
```

```
## Warning: Ignoring unknown parameters: nwidth
```
...
![](004_visualisasi_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
![](004_visualisasi_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
ggplot(data = evals, aes(x = age, y = score, colour = ethnicity)) +
  ...
  labs(
    x = "Umur",
    y = "Nilai",
    title = " Visualisasi Data umur & nilai"
  )
```

![](004_visualisasi_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
